...
// 이 코드에서 Shape 클래스의 draw 메서드는 비가상 메서드입니다. 따라서 Shape 타입의 포인터나 참조를 통해 draw를 호출하면 항상 Shape 클래스의 draw 메서드가 호출됩니다. 즉, 실제 객체가 Rectangle이나 Circle이라도 Shape의 draw가 호출됩니다.
